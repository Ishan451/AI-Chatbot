...
sample_candidates = [
    {
        "candidate_name": "Jashan Sehgal",
        "cgpa_score": 28,
        "experience_score": 15,
        "projects_score": 7
    },
    {
        "candidate_name": "Kevin Antony",
        "cgpa_score": 21,
        "experience_score": 15,
        "projects_score": 6
    },
    {
        "candidate_name": "Arshit",
        "cgpa_score": 30,
        "experience_score": 12,
        "projects_score": 8
    },
...
@app.route('/rank-candidates', methods=['GET'])
def rank_candidates():
    try:
        ranked_candidates = sorted(sample_candidates, key=lambda x: (x['cgpa_score'] + x['experience_score'] + x['projects_score']), reverse=True)
        for i, candidate in enumerate(ranked_candidates):
            candidate['total_score'] = candidate['cgpa_score'] + candidate['experience_score'] + candidate['projects_score']
            candidate['rank'] = i + 1
